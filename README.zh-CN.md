...
[官网](https://klp-launcher.com/) · [English](README.md) · [隐私政策](PRIVACY.zh-CN.md) · [使用条款](LICENSE.zh-CN) · [更新记录](CHANGELOG.zh-CN.md)
...
> 启动器本体的版权归苦力怕团队所有，保留一切权利，详见 [LICENSE.zh-CN](LICENSE.zh-CN)。
...
完整说明见 [PRIVACY.zh-CN.md](PRIVACY.zh-CN.md)，要点：
...
**你需要自行拥有正版 Minecraft。** 启动器不提供、不分发、不代购游戏授权，也不支持任何绕过正版验证的用途。详见 [LICENSE.zh-CN](LICENSE.zh-CN)。
